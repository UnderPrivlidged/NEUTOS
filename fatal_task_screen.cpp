...
namespace ams::fatal::srv {
    ...
    namespace {
        ...
        Result ShowFatalTask::ShowFatal() {
            ...
            font::AddSpacingLines(0.5f);
            font::PrintFormatLine(u8"Firmware: %s (UnderOS %u.%u.%u-%s)", config.GetFirmwareVersion().display_version, ATMOSPHERE_RELEASE_VERSION, ams::GetGitRevision());
            ...
            if (!exosphere::ResultVersionMismatch::Includes(this->context->result)) {
                ...
                font::Print(u8"UnderOS version mismatch detected.\n\n"
                                   ...
                                   u8"Please ensure that all UnderOS components are updated.\n"
                                   u8"github.com/UnderPrivlidged/UnderOS/releases/latest\n");
            }
